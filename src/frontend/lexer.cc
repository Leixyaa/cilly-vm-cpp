...
char Lexer::PeekNext() const {
  return current_ + 1 >= static_cast<int>(source_.size())
             ? '\0'
             : source_[current_ + 1];
}
...
Token Lexer::ScanIdentifier() {
  ...
  if (s == "var") {
    return MakeToken(TokenKind::kVar);
  } else if (s == "fun") {
    return MakeToken(TokenKind::kFun);
  } else if (s == "if") {
    return MakeToken(TokenKind::kIf);
  } else if (s == "else") {
    return MakeToken(TokenKind::kElse);
  } else if (s == "for") {
    return MakeToken(TokenKind::kFor);
  } else if (s == "while") {
    return MakeToken(TokenKind::kWhile);
  } else if (s == "break") {
    return MakeToken(TokenKind::kBreak);
  } else if (s == "continue") {
    return MakeToken(TokenKind::kContinue);
  } else if (s == "print") {
    return MakeToken(TokenKind::kPrint);
  } else if (s == "true") {
    return MakeToken(TokenKind::kTrue);
  } else if (s == "false") {
    return MakeToken(TokenKind::kFalse);
  } else if (s == "null") {
